...
// ORIGINAL PROGRAM CODE FROM https://gist.github.com/passy/637319
...
namespace GameUpdater.Services.Download
{
    public class ThrottledStream : Stream
    {
        ...
        public long MaximumBytesPerSecond
        {
            ...
            set
            {
                if (MaximumBytesPerSecond == value) return;
        ...
        private void Throttle(int bufferSizeInBytes)
        {
            ...
            var elapsedMilliseconds = CurrentMilliseconds - _start;
            ...
            if (bps <= _maximumBytesPerSecond) return;
        ...
        private void Reset()
        {
            var difference = CurrentMilliseconds - _start;
